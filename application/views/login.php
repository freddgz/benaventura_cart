...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>favicon.png">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <div class="login-box-img">
        <img src="<?= base_url() ?>assets/dist/img/logo.svg" alt="">
      </div>
      <p class="login-box-msg text-bold">IDENTIFÍCATE</p>
