...
define('ARRAY_DURACION', array(
    "1" => array("nombre" => "0 á 1 Hora", "desde" => 0, "hasta" => 1),
    "4" => array("nombre" => "1 á 4 Hora", "desde" => 1, "hasta" => 4),
    "8" => array("nombre" => "4 á 8 Hora", "desde" => 4, "hasta" => 8),
    "12" => array("nombre" => "8 á 12 Hora", "desde" => 8, "hasta" => 12),
));
/************************** EMAIL CONSTANTS *****************************/
